...
// ai_usage start
type ListAiUsagesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The maximum number of records to return. The service may return fewer than
	// this value.
	PageSize int32 `protobuf:"varint,1,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
...
func (x *ListAiUsagesRequest) Reset() {
	*x = ListAiUsagesRequest{}
	mi := &file_service_nem_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListAiUsagesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListAiUsagesRequest) ProtoMessage() {}

func (x *ListAiUsagesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_service_nem_proto_msgTypes[52]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListAiUsagesRequest.ProtoReflect.Descriptor instead.
func (*ListAiUsagesRequest) Descriptor() ([]byte, []int) {
	return file_service_nem_proto_rawDescGZIP(), []int{52}
}

func (x *ListAiUsagesRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListAiUsagesRequest) GetPageToken() string {
	if x != nil {
		return x.PageToken
	}
	return ""
...
func (x *ListAiUsagesRequest) GetFilter() string {
	if x != nil {
		return x.Filter
	}
	return ""
...
func (x *ListAiUsagesRequest) GetOrderBy() string {
	if x != nil {
		return x.OrderBy
	}
	return ""
...
type ListAiUsagesResponse struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	AiUsages []*AiUsage             `protobuf:"bytes,1,rep,name=ai_usages,json=aiUsages,proto3" json:"ai_usages,omitempty"`
	// A token that can be sent as `page_token` to retrieve the next page.
	// If this field is omitted, there are no subsequent pages.
	NextPageToken string `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ListAiUsagesResponse) Reset() {
	*x = ListAiUsagesResponse{}
	mi := &file_service_nem_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListAiUsagesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListAiUsagesResponse) ProtoMessage() {}

func (x *ListAiUsagesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_service_nem_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListAiUsagesResponse.ProtoReflect.Descriptor instead.
func (*ListAiUsagesResponse) Descriptor() ([]byte, []int) {
	return file_service_nem_proto_rawDescGZIP(), []int{53}
}

func (x *ListAiUsagesResponse) GetAiUsages() []*AiUsage {
	if x != nil {
		return x.AiUsages
	}
	return nil
...
func (x *ListAiUsagesResponse) GetNextPageToken() string {
	if x != nil {
		return x.NextPageToken
	}
	return ""
...
const file_service_nem_proto_rawDesc = "" +
	...
	"\x17ListMembershipsResponse\x121\n" +
	"\vmemberships\x18\x01 \x03(\v2\x0f.nem.MembershipR\vmemberships\x12&\n" +
	...
	"\vupdate_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\"\x84\x01\n" +
	"\x13ListAiUsagesRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12\x16\n" +
	"\x06filter\x18\x03 \x01(\tR\x06filter\x12\x19\n" +
	"\border_by\x18\x04 \x01(\tR\aorderBy\"i\n" +
	"\x14ListAiUsagesResponse\x12)\n" +
	"\tai_usages\x18\x01 \x03(\v2\f.nem.AiUsageR\baiUsages\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"?\n" +
	...
	"\x11UpdateUserProject\x12\x1d.nem.UpdateUserProjectRequest\x1a\x10.nem.UserProject\"\x00\x12N\n" +
	"\x0fListMemberships\x12\x1b.nem.ListMembershipsRequest\x1a\x1c.nem.ListMembershipsResponse\"\x00\x12C\n" +
...
var file_service_nem_proto_goTypes = []any{
	...
	(*ListAiUsagesRequest)(nil),             // 52: nem.ListAiUsagesRequest
