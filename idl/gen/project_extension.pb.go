...
const file_project_extension_proto_rawDesc = "" +
	"\n" +
	"\x17project_extension.proto\x12\x03nem\x1a\venums.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xda\x03\n" +
...
var file_project_extension_proto_goTypes = []any{
	(*ProjectExtension)(nil),      // 0: nem.ProjectExtension
	(ProjectExtensionStatus)(0),   // 1: nem.ProjectExtensionStatus
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_project_extension_proto_depIdxs = []int32{
	1, // 0: nem.ProjectExtension.status:type_name -> nem.ProjectExtensionStatus
