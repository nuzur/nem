...
const file_field_type_float_config_proto_rawDesc = "" +
	"\n" +
	"\x1dfield_type_float_config.proto\x12\x03nem\x1a\venums.proto\"\xee\x02\n" +
	...
	"\renable_limits\x18\b \x01(\bR\fenableLimitsB;\n" +
...
var file_field_type_float_config_proto_goTypes = []any{
	(*FieldTypeFloatConfig)(nil),       // 0: nem.FieldTypeFloatConfig
	(FieldTypeFloatConfigSeparator)(0), // 1: nem.FieldTypeFloatConfigSeparator
}
var file_field_type_float_config_proto_depIdxs = []int32{
	1, // 0: nem.FieldTypeFloatConfig.separator:type_name -> nem.FieldTypeFloatConfigSeparator
