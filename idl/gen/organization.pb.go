...
type Organization struct {
	...
	Status        OrganizationStatus     `protobuf:"varint,6,opt,name=status,proto3,enum=nem.OrganizationStatus" json:"status,omitempty"`
...
const file_organization_proto_rawDesc = "" +
	"\n" +
	"\x12organization.proto\x12\x03nem\x1a\x1fgoogle/protobuf/timestamp.proto\"\x82\x03\n" +
	"\fOrganization\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x03R\aversion\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x18\n" +
	"\adomains\x18\x04 \x03(\tR\adomains\x12\x1f\n" +
	"\vadmin_uuids\x18\x05 \x03(\tR\n" +
	"adminUuids\x12/\n" +
	"\x06status\x18\x06 \x01(\x0e2\x17.nem.OrganizationStatusR\x06status\x129\n" +
	"\n" +
	...
	"\x12OrganizationStatus\x12\x1f\n" +
	"\x1bORGANIZATION_STATUS_INVALID\x10\x00\x12\x1e\n" +
	"\x1aORGANIZATION_STATUS_ACTIVE\x10\x01\x12 \n" +
	"\x1cORGANIZATION_STATUS_DISABLED\x10\x02B3\n" +
	"\x14github.com/nuzur/nemB\fOrganizationP\x01Z\vnem/idl/genb\x06proto3"
...
var file_organization_proto_depIdxs = []int32{
	0, // 0: nem.Organization.status:type_name -> nem.OrganizationStatus
	2, // 1: nem.Organization.created_at:type_name -> google.protobuf.Timestamp
	2, // 2: nem.Organization.updated_at:type_name -> google.protobuf.Timestamp
