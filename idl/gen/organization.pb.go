...
const file_organization_proto_rawDesc = "" +
	"\n" +
	"\x12organization.proto\x12\x03nem\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x10membership.proto\"\xb5\x03\n" +
	...
	"\x06status\x18\a \x01(\x0e2\x17.nem.OrganizationStatusR\x06status\x129\n" +
	"\n" +
	...
	"\x0fupdated_by_uuid\x18\v \x01(\tR\rupdatedByUuid*w\n" +
