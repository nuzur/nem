...
const file_project_version_deployment_proto_rawDesc = "" +
	"\n" +
	" project_version_deployment.proto\x12\x03nem\"\x80\x01\n" +
	"\x18ProjectVersionDeployment\x12'\n" +
	"\x0fenviroment_uuid\x18\x01 \x01(\tR\x0eenviromentUuid\x12;\n" +
	"\x06status\x18\x02 \x01(\x0e2#.nem.ProjectVersionDeploymentStatusR\x06status*\xc3\x02\n" +
	...
	"-PROJECT_VERSION_DEPLOYMENT_STATUS_ROLLED_BACK\x10\x05B?\n" +
