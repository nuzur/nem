...
type Extension struct {
	...
	Status            ExtensionStatus        `protobuf:"varint,15,opt,name=status,proto3,enum=nem.ExtensionStatus" json:"status,omitempty"`
	OwnerUuid         string                 `protobuf:"bytes,16,opt,name=owner_uuid,json=ownerUuid,proto3" json:"owner_uuid,omitempty"`
	CreatedAt         *timestamppb.Timestamp `protobuf:"bytes,17,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	UpdatedAt         *timestamppb.Timestamp `protobuf:"bytes,18,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
	CreatedByUuid     string                 `protobuf:"bytes,19,opt,name=created_by_uuid,json=createdByUuid,proto3" json:"created_by_uuid,omitempty"`
	UpdatedByUuid     string                 `protobuf:"bytes,20,opt,name=updated_by_uuid,json=updatedByUuid,proto3" json:"updated_by_uuid,omitempty"`
...
func (x *Extension) GetVerified() bool {
	if x != nil {
		return x.Verified
	}
	return false
...
const file_extension_proto_rawDesc = "" +
	"\n" +
	"\x0fextension.proto\x12\x03nem\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x10visibility.proto\"\xe2\x05\n" +
	"\tExtension\x12\x12\n" +
	...
	"\bverified\x18\b \x01(\bR\bverified\x12\x1e\n" +
	"\n" +
	...
	"\n" +
	"visibility\x18\x0e \x03(\v2\x0f.nem.VisibilityR\n" +
	"visibility\x12,\n" +
	"\x06status\x18\x0f \x01(\x0e2\x14.nem.ExtensionStatusR\x06status\x12\x1d\n" +
	"\n" +
	"owner_uuid\x18\x10 \x01(\tR\townerUuid\x129\n" +
	"\n" +
	"created_at\x18\x11 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x12 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\x12&\n" +
	"\x0fcreated_by_uuid\x18\x13 \x01(\tR\rcreatedByUuid\x12&\n" +
	"\x0fupdated_by_uuid\x18\x14 \x01(\tR\rupdatedByUuid*\xb8\x01\n" +
