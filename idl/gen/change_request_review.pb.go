...
const file_change_request_review_proto_rawDesc = "" +
	"\n" +
	"\x1bchange_request_review.proto\x12\x03nem\x1a\venums.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x94\x02\n" +
...
var file_change_request_review_proto_goTypes = []any{
	(*ChangeRequestReview)(nil),      // 0: nem.ChangeRequestReview
	(ChangeRequestReviewResponse)(0), // 1: nem.ChangeRequestReviewResponse
	(*timestamppb.Timestamp)(nil),    // 2: google.protobuf.Timestamp
}
var file_change_request_review_proto_depIdxs = []int32{
	1, // 0: nem.ChangeRequestReview.response:type_name -> nem.ChangeRequestReviewResponse
