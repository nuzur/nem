...
const file_field_type_config_proto_rawDesc = "" +
	"\n" +
	"\x17field_type_config.proto\x12\x03nem\x1a\x1dfield_type_array_config.proto\x1a\x1cfield_type_char_config.proto\x1a\x1cfield_type_date_config.proto\x1a field_type_datetime_config.proto\x1a\x1ffield_type_decimal_config.proto\x1a\x1dfield_type_email_config.proto\x1a!field_type_encrypted_config.proto\x1a\x1cfield_type_enum_config.proto\x1a\x1cfield_type_file_config.proto\x1a\x1dfield_type_float_config.proto\x1a\x1ffield_type_integer_config.proto\x1a\x1cfield_type_json_config.proto\x1a\x1dfield_type_phone_config.proto\x1a\x1cfield_type_slug_config.proto\x1a\x1cfield_type_text_config.proto\x1a\x1bfield_type_url_config.proto\x1a\x1ffield_type_varchar_config.proto\"\xaf\t\n" +
	"\x0fFieldTypeConfig\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x125\n" +
	"\ainteger\x18\x02 \x01(\v2\x1b.nem.FieldTypeIntegerConfigR\ainteger\x12/\n" +
	"\x05float\x18\x03 \x01(\v2\x19.nem.FieldTypeFloatConfigR\x05float\x125\n" +
	"\adecimal\x18\x04 \x01(\v2\x1b.nem.FieldTypeDecimalConfigR\adecimal\x12\x18\n" +
	"\aboolean\x18\x05 \x01(\tR\aboolean\x12,\n" +
	"\x04char\x18\x06 \x01(\v2\x18.nem.FieldTypeCharConfigR\x04char\x125\n" +
	"\avarchar\x18\a \x01(\v2\x1b.nem.FieldTypeVarcharConfigR\avarchar\x12,\n" +
	"\x04text\x18\b \x01(\v2\x18.nem.FieldTypeTextConfigR\x04text\x12;\n" +
	"\tencrypted\x18\t \x01(\v2\x1d.nem.FieldTypeEncryptedConfigR\tencrypted\x12/\n" +
	"\x05email\x18\n" +
	" \x01(\v2\x19.nem.FieldTypeEmailConfigR\x05email\x12/\n" +
	"\x05phone\x18\v \x01(\v2\x19.nem.FieldTypePhoneConfigR\x05phone\x12)\n" +
	"\x03url\x18\f \x01(\v2\x17.nem.FieldTypeURLConfigR\x03url\x12\x1a\n" +
	"\blocation\x18\r \x01(\tR\blocation\x12\x14\n" +
	"\x05color\x18\x0e \x01(\tR\x05color\x12\x1b\n" +
	"\trich_text\x18\x0f \x01(\tR\brichText\x12\x12\n" +
	"\x04code\x18\x10 \x01(\tR\x04code\x12\x1a\n" +
	"\bmarkdown\x18\x11 \x01(\tR\bmarkdown\x12,\n" +
	"\x04file\x18\x12 \x01(\v2\x18.nem.FieldTypeFileConfigR\x04file\x12.\n" +
	"\x05image\x18\x13 \x01(\v2\x18.nem.FieldTypeFileConfigR\x05image\x12.\n" +
	"\x05video\x18\x14 \x01(\v2\x18.nem.FieldTypeFileConfigR\x05video\x12.\n" +
	"\x05audio\x18\x15 \x01(\v2\x18.nem.FieldTypeFileConfigR\x05audio\x12,\n" +
	"\x04enum\x18\x16 \x01(\v2\x18.nem.FieldTypeEnumConfigR\x04enum\x12,\n" +
	"\x04json\x18\x17 \x01(\v2\x18.nem.FieldTypeJSONConfigR\x04json\x12/\n" +
	"\x05array\x18\x18 \x01(\v2\x19.nem.FieldTypeArrayConfigR\x05array\x12,\n" +
	"\x04date\x18\x19 \x01(\v2\x18.nem.FieldTypeDateConfigR\x04date\x128\n" +
	"\bdatetime\x18\x1a \x01(\v2\x1c.nem.FieldTypeDatetimeConfigR\bdatetime\x12\x12\n" +
	"\x04time\x18\x1b \x01(\tR\x04time\x12,\n" +
	"\x04slug\x18\x1c \x01(\v2\x18.nem.FieldTypeSlugConfigR\x04slugB6\n" +
	"\x14github.com/nuzur/nemB\x0fFieldTypeConfigP\x01Z\vnem/idl/genb\x06proto3"

var (
	file_field_type_config_proto_rawDescOnce sync.Once
	file_field_type_config_proto_rawDescData []byte
)

func file_field_type_config_proto_rawDescGZIP() []byte {
	file_field_type_config_proto_rawDescOnce.Do(func() {
		file_field_type_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_field_type_config_proto_rawDesc), len(file_field_type_config_proto_rawDesc)))
	})
...
func file_field_type_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_field_type_config_proto_rawDesc), len(file_field_type_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
