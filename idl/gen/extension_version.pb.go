...
type ExtensionVersion struct {
	...
	ExecutionMode       ExtensionVersionExecutionMode `protobuf:"varint,8,opt,name=execution_mode,json=executionMode,proto3,enum=nem.ExtensionVersionExecutionMode" json:"execution_mode,omitempty"`
...
func (x *ExtensionVersion) GetExecutionMode() ExtensionVersionExecutionMode {
	...
	return ExtensionVersionExecutionMode_EXTENSION_VERSION_EXECUTION_MODE_INVALID
}
...
const file_extension_version_proto_rawDesc = "" +
	...
	"\x0eexecution_mode\x18\b \x01(\x0e2\".nem.ExtensionVersionExecutionModeR\rexecutionMode\x12F\n" +
