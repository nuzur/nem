...
const file_team_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"team.proto\x12\x03nem\x1a\x10connection.proto\x1a\fentity.proto\x1a\x10enviorment.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x10membership.proto\x1a\x12object_store.proto\x1a\x13review_config.proto\x1a\vstore.proto\"\xc6\x05\n" +
	"\x04Team\x12\x12\n" +
	...
	"\x0ereview_configs\x18\x05 \x03(\v2\x11.nem.ReviewConfigR\rreviewConfigs\x121\n" +
	"\vmemberships\x18\x06 \x03(\v2\x0f.nem.MembershipR\vmemberships\x12\"\n" +
	"\x06stores\x18\a \x03(\v2\n" +
	".nem.StoreR\x06stores\x121\n" +
	"\vconnections\x18\b \x03(\v2\x0f.nem.ConnectionR\vconnections\x125\n" +
	"\robject_stores\x18\t \x03(\v2\x10.nem.ObjectStoreR\fobjectStores\x12+\n" +
	"\x11organization_uuid\x18\n" +
	" \x01(\tR\x10organizationUuid\x122\n" +
	"\x0edefault_entity\x18\v \x01(\v2\v.nem.EntityR\rdefaultEntity\x12'\n" +
	"\x06status\x18\f \x01(\x0e2\x0f.nem.TeamStatusR\x06status\x129\n" +
	"\n" +
	...
	"\x0fupdated_by_uuid\x18\x10 \x01(\tR\rupdatedByUuid*W\n" +
	"\n" +
	"TeamStatus\x12\x17\n" +
