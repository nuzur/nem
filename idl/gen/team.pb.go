...
func (x *Team) GetOwnerUuid() string {
	if x != nil {
		return x.OwnerUuid
	}
	return ""
...
const file_team_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"team.proto\x12\x03nem\x1a\x10connection.proto\x1a\fentity.proto\x1a\venums.proto\x1a\x10enviorment.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x12object_store.proto\x1a\x13review_config.proto\x1a\vstore.proto\"\x85\x05\n" +
	"\x04Team\x12\x12\n" +
	...
	"\x0edefault_entity\x18\t \x01(\v2\v.nem.EntityR\rdefaultEntity\x12\x1d\n" +
	"\n" +
	"owner_uuid\x18\n" +
	" \x01(\tR\townerUuid\x12'\n" +
...
var file_team_proto_goTypes = []any{
	...
	(*Store)(nil),                 // 3: nem.Store
	(*Connection)(nil),            // 4: nem.Connection
	(*ObjectStore)(nil),           // 5: nem.ObjectStore
	(*Entity)(nil),                // 6: nem.Entity
	(TeamStatus)(0),               // 7: nem.TeamStatus
	(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
}
var file_team_proto_depIdxs = []int32{
	1, // 0: nem.Team.enviorments:type_name -> nem.Enviorment
	2, // 1: nem.Team.review_configs:type_name -> nem.ReviewConfig
	3, // 2: nem.Team.stores:type_name -> nem.Store
	4, // 3: nem.Team.connections:type_name -> nem.Connection
	5, // 4: nem.Team.object_stores:type_name -> nem.ObjectStore
	6, // 5: nem.Team.default_entity:type_name -> nem.Entity
	7, // 6: nem.Team.status:type_name -> nem.TeamStatus
