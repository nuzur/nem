...
const file_project_version_proto_rawDesc = "" +
	...
	"enum.proto\x1a\venums.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a project_version_deployment.proto\x1a\x12relationship.proto\x1a\rservice.proto\"\xfc\x05\n" +
	...
	"\x0fupdated_by_uuid\x18\x11 \x01(\tR\rupdatedByUuidB5\n" +
...
var file_project_version_proto_goTypes = []any{
	(*ProjectVersion)(nil),           // 0: nem.ProjectVersion
	(*Entity)(nil),                   // 1: nem.Entity
	(*Relationship)(nil),             // 2: nem.Relationship
	(*Enum)(nil),                     // 3: nem.Enum
	(*Service)(nil),                  // 4: nem.Service
	(ProjectVersionReviewStatus)(0),  // 5: nem.ProjectVersionReviewStatus
	(*ProjectVersionDeployment)(nil), // 6: nem.ProjectVersionDeployment
	(ProjectVersionStatus)(0),        // 7: nem.ProjectVersionStatus
	(*timestamppb.Timestamp)(nil),    // 8: google.protobuf.Timestamp
}
var file_project_version_proto_depIdxs = []int32{
	1, // 0: nem.ProjectVersion.entities:type_name -> nem.Entity
	2, // 1: nem.ProjectVersion.relationships:type_name -> nem.Relationship
	3, // 2: nem.ProjectVersion.enums:type_name -> nem.Enum
	4, // 3: nem.ProjectVersion.services:type_name -> nem.Service
	5, // 4: nem.ProjectVersion.review_status:type_name -> nem.ProjectVersionReviewStatus
	6, // 5: nem.ProjectVersion.deployments:type_name -> nem.ProjectVersionDeployment
	7, // 6: nem.ProjectVersion.status:type_name -> nem.ProjectVersionStatus
