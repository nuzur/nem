...
var file_entity_version_type_entity_config_proto_rawDesc = string([]byte{
	...
	0x42, 0x44, 0x0a, 0x14, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6e,
	0x75, 0x7a, 0x75, 0x72, 0x2f, 0x6e, 0x65, 0x6d, 0x42, 0x1d, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79,
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x45, 0x6e, 0x74, 0x69, 0x74,
	0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x01, 0x5a, 0x0b, 0x6e, 0x65, 0x6d, 0x2f, 0x69,
...
var (
	...
	file_entity_version_type_entity_config_proto_rawDescData []byte
)
...
func file_entity_version_type_entity_config_proto_rawDescGZIP() []byte {
	file_entity_version_type_entity_config_proto_rawDescOnce.Do(func() {
		file_entity_version_type_entity_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_entity_version_type_entity_config_proto_rawDesc), len(file_entity_version_type_entity_config_proto_rawDesc)))
	})
...
func file_entity_version_type_entity_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_entity_version_type_entity_config_proto_rawDesc), len(file_entity_version_type_entity_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
