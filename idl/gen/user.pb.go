...
type User struct {
	...
	UserType      UserType               `protobuf:"varint,6,opt,name=user_type,json=userType,proto3,enum=nem.UserType" json:"user_type,omitempty"`
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x03nem\x1a\venums.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa3\x03\n" +
	"\x04User\x12\x12\n" +
	...
	"\tuser_type\x18\x06 \x01(\x0e2\r.nem.UserTypeR\buserType\x12!\n" +
...
var file_user_proto_goTypes = []any{
	(*User)(nil),                  // 0: nem.User
	(UserType)(0),                 // 1: nem.UserType
	(UserStatus)(0),               // 2: nem.UserStatus
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_user_proto_depIdxs = []int32{
	1, // 0: nem.User.user_type:type_name -> nem.UserType
	2, // 1: nem.User.status:type_name -> nem.UserStatus
