...
const file_tcp_ip_connection_type_config_proto_rawDesc = "" +
	"\n" +
	"#tcp_ip_connection_type_config.proto\x12\x03nem\"\x83\x01\n" +
	"\x19TcpIpConnectionTypeConfig\x12\x1a\n" +
	"\bhostname\x18\x01 \x01(\tR\bhostname\x12\x12\n" +
	"\x04port\x18\x02 \x01(\tR\x04port\x12\x1a\n" +
	"\busername\x18\x03 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x04 \x01(\tR\bpasswordB@\n" +
	"\x14github.com/nuzur/nemB\x19TcpIpConnectionTypeConfigP\x01Z\vnem/idl/genb\x06proto3"

var (
	file_tcp_ip_connection_type_config_proto_rawDescOnce sync.Once
	file_tcp_ip_connection_type_config_proto_rawDescData []byte
)
...
func file_tcp_ip_connection_type_config_proto_rawDescGZIP() []byte {
	file_tcp_ip_connection_type_config_proto_rawDescOnce.Do(func() {
		file_tcp_ip_connection_type_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tcp_ip_connection_type_config_proto_rawDesc), len(file_tcp_ip_connection_type_config_proto_rawDesc)))
	})
...
func file_tcp_ip_connection_type_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tcp_ip_connection_type_config_proto_rawDesc), len(file_tcp_ip_connection_type_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
