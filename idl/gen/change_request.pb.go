...
const file_change_request_proto_rawDesc = "" +
	"\n" +
	"\x14change_request.proto\x12\x03nem\x1a change_request_data_change.proto\x1a\x1bchange_request_review.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xda\x05\n" +
	...
	"changeType\x12?\n" +
	"\fdata_changes\x18\b \x03(\v2\x1c.nem.ChangeRequestDataChangeR\vdataChanges\x122\n" +
