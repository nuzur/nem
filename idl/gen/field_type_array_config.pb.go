...
const file_field_type_array_config_proto_rawDesc = "" +
	"\n" +
	"\x1dfield_type_array_config.proto\x12\x03nem\x1a\x17array_type_config.proto\x1a\venums.proto\"\xed\x01\n" +
...
var file_field_type_array_config_proto_goTypes = []any{
	(*FieldTypeArrayConfig)(nil),  // 0: nem.FieldTypeArrayConfig
	(FieldTypeArrayConfigType)(0), // 1: nem.FieldTypeArrayConfigType
	(*ArrayTypeConfig)(nil),       // 2: nem.ArrayTypeConfig
}
var file_field_type_array_config_proto_depIdxs = []int32{
	1, // 0: nem.FieldTypeArrayConfig.type:type_name -> nem.FieldTypeArrayConfigType
