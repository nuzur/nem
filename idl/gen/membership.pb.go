...
const file_membership_proto_rawDesc = "" +
	"\n" +
	"\x10membership.proto\x12\x03nem\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc3\x03\n" +
	"\n" +
	"Membership\x12\x12\n" +
...
var file_membership_proto_depIdxs = []int32{
	...
	3, // 1: nem.Membership.start_date:type_name -> google.protobuf.Timestamp
	0, // 2: nem.Membership.status:type_name -> nem.MembershipStatus
	3, // 3: nem.Membership.created_at:type_name -> google.protobuf.Timestamp
	3, // 4: nem.Membership.updated_at:type_name -> google.protobuf.Timestamp
