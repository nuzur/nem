...
const file_field_type_integer_config_proto_rawDesc = "" +
	"\n" +
	"\x1ffield_type_integer_config.proto\x12\x03nem\x1a\venums.proto\"\xb5\x02\n" +
	...
	"\renable_limits\x18\a \x01(\bR\fenableLimitsB=\n" +
...
var file_field_type_integer_config_proto_goTypes = []any{
	(*FieldTypeIntegerConfig)(nil),  // 0: nem.FieldTypeIntegerConfig
	(FieldTypeIntegerConfigSize)(0), // 1: nem.FieldTypeIntegerConfigSize
}
var file_field_type_integer_config_proto_depIdxs = []int32{
	1, // 0: nem.FieldTypeIntegerConfig.size:type_name -> nem.FieldTypeIntegerConfigSize
