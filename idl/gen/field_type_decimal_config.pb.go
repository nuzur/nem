...
const file_field_type_decimal_config_proto_rawDesc = "" +
	"\n" +
	"\x1ffield_type_decimal_config.proto\x12\x03nem\x1a\venums.proto\"\xb8\x03\n" +
...
var file_field_type_decimal_config_proto_goTypes = []any{
	(*FieldTypeDecimalConfig)(nil),       // 0: nem.FieldTypeDecimalConfig
	(FieldTypeDecimalConfigSeparator)(0), // 1: nem.FieldTypeDecimalConfigSeparator
}
var file_field_type_decimal_config_proto_depIdxs = []int32{
	1, // 0: nem.FieldTypeDecimalConfig.separator:type_name -> nem.FieldTypeDecimalConfigSeparator
