...
const (
	...
	ExtensionExecutionStatus_EXTENSION_EXECUTION_STATUS_QUEUED     ExtensionExecutionStatus = 5
)
...
var (
	ExtensionExecutionStatus_name = map[int32]string{
		...
		5: "EXTENSION_EXECUTION_STATUS_QUEUED",
	}
	ExtensionExecutionStatus_value = map[string]int32{
		...
		"EXTENSION_EXECUTION_STATUS_QUEUED":     5,
	}
)
...
const file_enums_proto_rawDesc = "" +
	...
	"\x1aENVIORMENT_STATUS_DISABLED\x10\x02*\x8f\x02\n" +
	...
	"$EXTENSION_EXECUTION_STATUS_CANCELLED\x10\x04\x12%\n" +
	"!EXTENSION_EXECUTION_STATUS_QUEUED\x10\x05*k\n" +
