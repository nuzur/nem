...
func BuildListProjectRequest(ctx context.Context, request *pb.ListProjectRequest) (types.ListRequest, *pagination.PageToken, error) {
	err := validatePageSizeForListProject(request)
	if err != nil {
...
func (s *server) ListProject(ctx context.Context, request *pb.ListProjectRequest) (*pb.ListProjectResponse, error) {

	var err error
	req, pageToken, err := BuildListProjectRequest(ctx, request)
	if err != nil {
	...
	if request.GetSkipCache() {
		result, err = s.core.Project().List(ctx, req, projectmodule.WithSkipCache())
	} else {
	...
	// Build the response.
	response := &pb.ListProjectResponse{
		Project: pbmapper.ProjectSliceToProto(result.Project),
	}
...
func validatePageSizeForListProject(request *pb.ListProjectRequest) error {
