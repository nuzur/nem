...
func BuildListUserProjectRequest(ctx context.Context, request *pb.ListUserProjectRequest) (types.ListRequest, *pagination.PageToken, error) {
	err := validatePageSizeForListUserProject(request)
	if err != nil {
...
func (s *server) ListUserProject(ctx context.Context, request *pb.ListUserProjectRequest) (*pb.ListUserProjectResponse, error) {

	var err error
	req, pageToken, err := BuildListUserProjectRequest(ctx, request)
	if err != nil {
	...
	if request.GetSkipCache() {
		result, err = s.core.UserProject().List(ctx, req, user_projectmodule.WithSkipCache())
	} else {
	...
	// Build the response.
	response := &pb.ListUserProjectResponse{
		UserProject: pbmapper.UserProjectSliceToProto(result.UserProject),
	}
...
func validatePageSizeForListUserProject(request *pb.ListUserProjectRequest) error {
