...
func BuildListUserProjectVersionRequest(ctx context.Context, request *pb.ListUserProjectVersionRequest) (types.ListRequest, *pagination.PageToken, error) {
	err := validatePageSizeForListUserProjectVersion(request)
	if err != nil {
...
func (s *server) ListUserProjectVersion(ctx context.Context, request *pb.ListUserProjectVersionRequest) (*pb.ListUserProjectVersionResponse, error) {

	var err error
	req, pageToken, err := BuildListUserProjectVersionRequest(ctx, request)
	if err != nil {
	...
	if request.GetSkipCache() {
		result, err = s.core.UserProjectVersion().List(ctx, req, user_project_versionmodule.WithSkipCache())
	} else {
	...
	// Build the response.
	response := &pb.ListUserProjectVersionResponse{
		UserProjectVersion: pbmapper.UserProjectVersionSliceToProto(result.UserProjectVersion),
	}
...
func validatePageSizeForListUserProjectVersion(request *pb.ListUserProjectVersionRequest) error {
