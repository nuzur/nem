...
func (m *module) List(ctx context.Context,
	...
	cacheKey := fmt.Sprintf("ListMembership:%v", request)
	if !skipShared {
	...
	list := func() (any, error) {
		...
		if err != nil {
			...
			m.logger.Error("error in executing query for ListMembership", zap.String("query", query), zap.Error(err))
			return types.ListResponse{}, err
		}
		defer rows.Close()
		var scanGetters []func(*repogen.Membership) any
		...
		return types.ListResponse{
			Membership:  mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Membership) any{

	"uuid": func(i *repogen.Membership) any { return &i.UUID },

	"owner_uuid": func(i *repogen.Membership) any { return &i.OwnerUUID },

	"type": func(i *repogen.Membership) any { return &i.Type },

	"start_date": func(i *repogen.Membership) any { return &i.StartDate },

	"billing_metadata": func(i *repogen.Membership) any { return &i.BillingMetadata },

	"status": func(i *repogen.Membership) any { return &i.Status },

	"created_at": func(i *repogen.Membership) any { return &i.CreatedAt },

	"updated_at": func(i *repogen.Membership) any { return &i.UpdatedAt },

	"created_by_uuid": func(i *repogen.Membership) any { return &i.CreatedByUUID },

	"updated_by_uuid": func(i *repogen.Membership) any { return &i.UpdatedByUUID },
}
