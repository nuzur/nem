...
type Module interface {
	FetchAutomationByUUID(ctx context.Context, req types.FetchAutomationByUUIDRequest, opts ...Option) (types.FetchAutomationByUUIDResponse, error)
	FetchAutomationByProjectUUIDAndEntityUUIDAndEnabled(ctx context.Context, req types.FetchAutomationByProjectUUIDAndEntityUUIDAndEnabledRequest, opts ...Option) (types.FetchAutomationByProjectUUIDAndEntityUUIDAndEnabledResponse, error)
	FetchAutomationByStatus(ctx context.Context, req types.FetchAutomationByStatusRequest, opts ...Option) (types.FetchAutomationByStatusResponse, error)
