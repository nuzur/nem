...
func (e UserTeam) FieldIdentifierToTypeMap() map[string]entitytypes.FieldType {
...
func (e UserTeam) DependantFieldIdentifierToTypeMap() map[string]map[string]entitytypes.FieldType {
...
func (e UserTeam) PrimaryKeyIdentifiers() []string {
	return []string{
		"uuid",
	}
}

func (e UserTeam) ArrayFieldIdentifierToType() map[string]entitytypes.FieldType {
