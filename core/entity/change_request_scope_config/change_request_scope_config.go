...
func (e ChangeRequestScopeConfig) PrimaryKeyValues() []string {
	return []string{}
}
...
func ChangeRequestScopeConfigFromJSON(data json.RawMessage) ChangeRequestScopeConfig {
	...
	if err := json.Unmarshal(data, &entity); err != nil {
		if err2 := mapper.FlexibleUnmarshal(data, &entity); err2 != nil {
			log.Printf("flexible unmarshal error ChangeRequestScopeConfigFromJSON: %v\n", err2)
		}
	}
	return entity
}
	...
	if err := json.Unmarshal(data, &entity); err != nil {
		...
		if err2 := json.Unmarshal(data, &rawSlice); err2 == nil {
			for _, raw := range rawSlice {
				item := ChangeRequestScopeConfig{}
				if err3 := mapper.FlexibleUnmarshal(raw, &item); err3 != nil {
					log.Printf("flexible unmarshal error ChangeRequestScopeConfigSliceFromJSON item: %v\n", err3)
				}
...
func (e ChangeRequestScopeConfig) ToJSON() json.RawMessage {
	...
	if err != nil {
		log.Printf("marshal error ChangeRequestScopeConfigToJSON: %v\n", err)
	}
	return res
}
...
func ChangeRequestScopeConfigSliceToJSON(e []ChangeRequestScopeConfig) json.RawMessage {
	...
	res, err := json.Marshal(e)
	if err != nil {
		log.Printf("marshal error ChangeRequestScopeConfigSliceToJSON: %v\n", err)
	}
	return res
}
